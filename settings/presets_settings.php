...
$page = new admin_settingpage('theme_waxed_presets', get_string('presets_settings', 'theme_waxed'));
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_waxed', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_waxed/presetfiles';
$title = get_string('presetfiles', 'theme_waxed');
$description = get_string('presetfiles_desc', 'theme_waxed');
